...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "moonhouse".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["giveup.icu"];
pub const RS_PUB_KEY: &str = "bqOigs8g8YuMQrrjApnCcWQr4SpntappMiwU26BtCL0=";
